...
{
    return getJackInterface()->client_close(client);
}
...
{
    return getJackInterface()->get_client_name(client);
}

int meta_jack_activate (jack_client_t *client)
{
    return getJackInterface()->activate(client);
}

int meta_jack_deactivate (jack_client_t *client)
{
    return getJackInterface()->deactivate(client);
}
...
{
    return getJackInterface()->set_client_registration_callback(client, registration_callback, arg);
}
